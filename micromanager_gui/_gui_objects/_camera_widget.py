...
class MMCameraWidget(QtW.QWidget):
    ...
    def setup_gui(self):
        ...
        self.cam_px_label.setMinimumWidth(70)
        ...
        self.px_size_doubleSpinBox.setMaximumWidth(150)
        self.px_size_doubleSpinBox.setMinimumWidth(150)
        ...
        self.main_layout.addWidget(self.cam_px_wdg, 0, 0)
        ...
        self.main_layout.addWidget(self.cam_roi_wdg, 0, 1)
