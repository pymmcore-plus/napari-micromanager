...
class MMEventCallback:
    ...
    def onPropertyChanged(
        self, dev_name: str, prop_name: str, prop_val: str
    ) -> None: ...
    def onChannelGroupChanged(self, new_channel_group_name: str) -> None: ...
    def onConfigGroupChanged(self, group_name: str, new_config_name: str) -> None: ...
    def onSystemConfigurationLoaded(self) -> None: ...
    def onPixelSizeChanged(self, new_pixel_size_um: float) -> None: ...
    def onPixelSizeAffineChanged(self, v0, v1, v2, v3, v4, v5) -> None: ...
    ...
    def onExposureChanged(self, name: str, new_exposure: float) -> None: ...
    def onSLMExposureChanged(self, name: str, new_exposure: float) -> None: ...
...
class CMMCore:
    ...
    def saveSystemConfiguration(self, fileName: str) -> None:
        """Save system Config"""
        ...
    def loadSystemConfiguration(self, fileName: str = "demo") -> None: ...
